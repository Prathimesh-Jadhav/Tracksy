...
const LandingPage = () => {
    ...
    return (
        <div className='w-full relative min-h-screen bg-gradient-to-br from-violet-100 to-blue-100'>
            <LandingPageNav setShowLogin={setShowLogin} />

            {/* content */}
            <div className='max-w-[900px] mx-auto px-16 max-md:px-6 mt-16 max-md:mt-14 '>
                <div className='flex flex-col items-center justify-center content'>
                    ...
                    <div className='w-full flex justify-center items-center gap-6 max-md:flex-col-reverse max-md:gap-4 heading'>
                        <button
                            ...
                            className="relative z-10 py-2 px-6 text-white rounded-full border-2 border-gray-400 group overflow-hidden"
                        >
                            <span className="absolute inset-0 bg-black -translate-x-full group-hover:translate-x-0 transition-transform duration-300 ease-in-out z-[-1]" />
                            <span className="relative z-10 text-primary group-hover:text-white transition-colors duration-300">
                                Get Started
                            </span>
                        </button>

                        {/* <div className='p-1 relative flex items-center h-16 w-[100px]'>
                            {landComments.map((comment, i) => (
                                <Profile
                                    key={i}
                                    image={comment.image}
            ...
            {/* features */}
            <div className='max-w-[1200px] mx-auto px-12 max-md:px-6 mt-14 max-md:mt-14 flex justify-between items-center flex-wrap max-md:justify-center gap-4 image'>
                <div className="group relative max-w-[300px] bg-white/70 backdrop-blur-sm rounded-3xl px-4 py-2  transition-all duration-500 transform  border border-gray-200  overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        {/* <div className="flex flex-wrap gap-2 mb-6">
                            <span className="px-3 py-1 bg-blue-100 text-blue-700 text-sm rounded-full font-medium">Live Analytics</span>
                            <span className="px-3 py-1 bg-cyan-100 text-cyan-700 text-sm rounded-full font-medium">Sales Insights</span>
                        </div> */}

                        {/* Glassmorphism button */}
                        {/* <button className="w-full py-3 px-6 bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-cyan-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                            Explore Dashboard
                        </button> */}
                    </div>
                </div>
                ...
                <div className="group relative bg-white/70 backdrop-blur-sm rounded-3xl px-4 py-2 transition-all duration-500 transform shadow-md border border-white/50 overflow-hidden max-w-[320px]">
                    {/* Animated background */}
                    ...
                    <div className="relative z-10">
                        {/* Icon with glow effect */}
                        <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:shadow-emerald-500/25 group-hover:shadow-xl transition-all duration-300 group-hover:rotate-3">
                            <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
