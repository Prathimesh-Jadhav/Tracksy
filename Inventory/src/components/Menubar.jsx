...
const Menubar = ({ openMenu, setOpenMenu }) => {
  ...
  return (
    <div className={`flex flex-col min-h-[100dvh] max-h-[100dvh] dark:border-gray-600 bg-gray-100 dark:bg-gray-800 max-w-[300px] min-w-[300px] fixed right-0 top-0 shadow-md z-50 bottom-0 ${openMenu ? 'translate-x-0' : 'translate-x-full'} transition-all duration-500 ease-in-out border-2 rounded-l-lg md:hidden py-6 px-3`}>
      {/* Logo and Title  */}
